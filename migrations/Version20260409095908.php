 ...
 */
final class Version20260409095908 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE stock (id INT AUTO_INCREMENT NOT NULL, type VARCHAR(255) NOT NULL, quantité INT NOT NULL, référence VARCHAR(255) NOT NULL, prix_unitaire INT NOT NULL, PRIMARY KEY (id)) DEFAULT CHARACTER SET utf8mb4');
